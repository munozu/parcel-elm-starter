			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Parcel Elm!')
							])),
						A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('elm parcel starter')
							]))
					]))
			]));
};
...
},{"./Main.elm":"Main.elm","./registerServiceWorker":"registerServiceWorker.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
